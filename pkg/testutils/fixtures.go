...
func (fm *FixtureManager) LoadJSON(name string, target any) error {
	data, err := fm.Load(name)
	if err != nil {
		return err
	}
...
func (fm *FixtureManager) SaveJSON(name string, data any) error {
...
func TestFixtureJSON(t *testing.T, name string, target any) {
	t.Helper()
