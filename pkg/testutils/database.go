...
func (db *TestDatabase) Repository(model database.Entity) interface{} {
...
func (db *TestDatabase) Seed(table string, data map[string]interface{}) (string, error) {
...
func (db *TestDatabase) ExecuteSQL(query string, args ...interface{}) error {
	_, err := db.Exec(query, args...)
	return err
}

// AssertCount verifies the number of rows in a table
func (db *TestDatabase) AssertCount(table string, expected int, where string, args ...interface{}) {
	var count int
